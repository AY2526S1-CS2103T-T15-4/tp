...
public class HomeCountry {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Countries should only be alphanumeric, not be blank and not exceed "
            + LENGTH_LIMIT + " characters, including spaces.a";
