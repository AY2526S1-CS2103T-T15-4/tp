...
public class EditCommand extends ConfirmableCommand {
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        return new Person(updatedName, updatedPhone, updatedEmail, updatedCountry, updatedCompany, updatedTags, unchangedMeetings);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public void setCountry(HomeCountry country) {
            this.country = country;
        }

        public Optional<HomeCountry> getCountry() {
