...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_COUNTRY_DESC,
                HomeCountry.MESSAGE_CONSTRAINTS); // invalid country
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_COUNTRY_AMY
                        + VALID_COUNTRY_AMY + VALID_PHONE_AMY,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + COUNTRY_DESC_AMY + COMPANY_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + COUNTRY_DESC_AMY + COMPANY_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND + PHONE_DESC_AMY + COUNTRY_DESC_AMY + COMPANY_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND + PHONE_DESC_BOB + COUNTRY_DESC_BOB + COMPANY_DESC_BOB
        ...
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_COUNTRY_DESC + INVALID_COMPANY_DESC
                + INVALID_EMAIL_DESC + INVALID_PHONE_DESC + INVALID_COUNTRY_DESC + INVALID_COMPANY_DESC
                + INVALID_EMAIL_DESC;
