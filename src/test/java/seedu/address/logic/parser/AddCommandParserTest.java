...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + COUNTRY_DESC_BOB + COMPANY_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + COUNTRY_DESC_BOB + COMPANY_DESC_BOB
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + COUNTRY_DESC_BOB + COMPANY_DESC_BOB + TAG_DESC_FRIEND;
        ...
        assertParseFailure(parser,
                ...
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_COUNTRY, PREFIX_COMPANY,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + COUNTRY_DESC_AMY
                        + COMPANY_DESC_AMY,
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + INVALID_COUNTRY_DESC
                + COMPANY_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, HomeCountry.MESSAGE_CONSTRAINTS);

        // invalid company
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + COUNTRY_DESC_BOB
                + INVALID_COMPANY_DESC + TAG_DESC_HUSBAND + VALID_TAG_FRIEND, Company.MESSAGE_CONSTRAINTS);
